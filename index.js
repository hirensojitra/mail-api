...
app.post('/api/send-email', async (req, res) => {
  try {
    ...
    if (!targetEmail) throw new Error('Target email not configured');
...
// Other API endpoints
app.post('/api/agni', (req, res) => {
  console.log('Received request for /api/agni');
  res.json({ success: true, message: 'Agni endpoint called successfully!' });
});

app.post('/api/kavach', (req, res) => {
  console.log('Received request for /api/kavach');
  res.json({ success: true, message: 'Kavach endpoint called successfully!' });
});
